...
$password=$_REQUEST['password'];
 $_SESSION['un']=$email;
 $qry="select * from admin_details where username='$name' && password='$password'";
            ...
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav me-lg-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="admin.php">Admin</a>                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="trust.php">Trust</a>                        </li>
                       
                        <li class="nav-item">
                            <a class="nav-link" href="donor.php">Donor</a>                        </li>
            ...
            <div class="container">
                <div class="contactct-fm map-content-9">
                    <div class="header-title text-center">
                        ...
                        <h3 class="title-w3l mb-2">ADMIN
                            <span class="span-bold"> LOGIN</span>
                        </h3>
                    ...
                    <form action="" class="pt-lg-4" method="post" enctype="multipart/form-data">
					  <table height="270" align="center">
                        <tr>
                          ...
                          <td width="311"><input type="text" name="username" placeholder="Username" required=""></td>
                        </tr>
                        <tr>
                          <td>Password</td>
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td><span class="tp">
                            <button type="submit" name="btn" class="btn btn-primary btn-style mt-lg-5 mt-4">Login</button>
                          </span></td>
                        </tr>
                      </table>
