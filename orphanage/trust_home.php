            ...
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav me-lg-auto my-2 my-lg-0 navbar-nav-scroll">
                        <li class="nav-item">
                            <a class="nav-link active " aria-current="page" href="trust_home.php">Home</a>                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="trust_view_donation.php">View Donation</a>                        </li>
                     <li class="nav-item">
                            <a class="nav-link " href="trust_view_donor.php">View Donor</a>                        </li>
                        <li class="nav-item">
                ...
                <div class="contactct-fm map-content-9">
                    <div class="header-title text-center">
                        ...
                        <h3 class="title-w3l mb-2">TRUST
                            <span class="span-bold"> HOME</span>
                        </h3>
