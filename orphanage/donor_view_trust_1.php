...
$amount=$_REQUEST['amount'];
 $sql = "SELECT id FROM payment_details order by id ASC";
 ...
 $sid=0;
  ...
  while($row = $result->fetch_assoc()) 
  {
   ...
   $qrys1="insert into payment_details values($sid,'$id','$username','$amount','$date1','$time1')";
            ...
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav me-lg-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="donor_view_trust.php">View Trust</a>                        </li>
						 <li class="nav-item">
                            <a class="nav-link " href="donor_view_donation.php">Donation</a>                        </li>
            ...
            <div class="container">
                <div class="contactct-fm map-content-9">
                    <div class="header-title text-center">
                        ...
                        <h3 class="title-w3l mb-2">Donation</h3>
                       
                  </div>
					
                    <form action="" class="pt-lg-4" method="post" enctype="multipart/form-data">
                      <table width="43%" height="127" align="center">
                        <tr>
                        ...
                        <tr>
                          <td>Card No </td>
                          <td><input name="amount2" type="text" id="amount2" required=""></td>
                        </tr>
                        <tr>
                          <td>Holder Name </td>
                          <td><input name="amount3" type="text" id="amount3" required=""></td>
                        </tr>
                        <tr>
                          <td>CVV</td>
                          <td><input name="amount4" type="text" id="amount4" required=""></td>
                        </tr>
                        <tr>
                          <td>Ex-Date</td>
                          <td><input name="amount5" type="text" id="amount5" required=""></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td><label>
